...
export const caseStudies: Record<string, CaseStudy> = {
  Reminiscape: {
    ...
    outcome: {
      en: "Won the Corporate Prize at the Exhibition + E-Ten showcase. My most complete application to date (~300–400 hrs, solo) — the build that gave me confidence I can take a product from idea to working app on my own.",
  ...
  SpaceLang: {
    ...
    outcome: {
      en: "Won two HTML5 Award 2023 prizes — the Design Prize and the IMAKE Prize. ~103 hrs.",
